...
class Tampilan:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("Data Siswa")
        self.root.configure(background='#008CBA')

        self.input_frame = ttk.LabelFrame(text="Input Data Siswa")
        self.input_frame.pack(side=tk.LEFT, padx=20)

        self.NIM = ttk.Label(self.input_frame, text= "Nama :")
        ...
        self.nama = ttk.Label(self.input_frame, text= "Alamat :")
        ...
        self.add_button = ttk.Button(
            self.button_frame, text="Simpan", style='primary.TButton', command=self.add_data
        )
